...
import { BehaviorSubject, merge, Subscription, combineLatest } from 'rxjs';
...
export class OrganizationService {
  ...
  private getCompanies() {
    return this.http.disableHeader().get<any>('personal/organization', { params: { name: 'company', lang: this.i18n.language } }).pipe(
  ...
  private getDivisions(companyCode) {
    return this.http.disableHeader().get<any>('personal/organization', { params: { name: 'division', companyCode: companyCode, lang: this.i18n.language } }).pipe(
